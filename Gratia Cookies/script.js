document.addEventListener("DOMContentLoaded", () => {
  ...
  // FLAVOUR SELECTOR
  const flavourBtns = document.getElementById("flavour-btn");
  ...
  function updateCartUI() {
    ...
    // Subtotal
    document.getElementById("cartSubtotal").textContent = `₦${totalPrice.toLocalString()}`;
...
<div class="cart-item-bottom"><span class="cart-item-price">₦${(item.price * item.qty).toLocaleString()}</span>
